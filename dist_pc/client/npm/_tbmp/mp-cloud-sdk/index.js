!function (t, e) {
  ...
  var n = function (t, e) {
    ...
    return p(this, undefined, undefined, function () {
      return k(this, function (t) {
        switch (t.label) {case 0:
            return this.options = h({}, e), this.proxy = r, this.tasks = [], this.inited = true, [4, this.listenNetworkChange()];case 1:
    ...
    return p(this, undefined, undefined, function () {
      var e,
          r = this;return k(this, function (t) {
        switch (t.label) {case 0:
    ...
    return p(this, undefined, undefined, function () {
      return k(this, function (t) {
        switch (t.label) {case 0:
            if (T(n, "mc-code") || T(e, "errCode") || T(e, "error_response.code"), r.__is_retry_task__) return this.tryThrowError(e, n), [2, e];t.label = 1;case 1:
    ...
    var r = T(e, "mc-msg") || T(t, "errMsg") || T(t, "error_response.msg"),
        n = T(e, "mc-code") || T(t, "errCode") || T(t, "error_response.code");if (n && "200" != n) {
    ...
    return p(this, undefined, undefined, function () {
      var e,
        ...
        switch (t.label) {case 0:
            ...
            return n = this.createGatewayRequest(n), [4, this.proxy.apply(h({}, n), d.GATEWAY)];case 2:
            return e = t.sent(), [4, this.verifyResponse(T(e, "data"), n, T(e, "headers"))];case 3:
            return [2, t.sent()];}
      });
    });
    ...
    var i = this;undefined === o && (o = false), this.tasks.forEach(function (t) {
      var e = t.detail,
          r = t.success,
          n = t.fail;if (o) return n("初始化失败");i.exec(e, d.GATEWAY).then(r).catch(n);
    }), this.tasks = [];
  }, g.prototype.exec = function (e, r) {
    return p(this, undefined, undefined, function () {
      return k(this, function (t) {
        switch (t.label) {case 0:
            if (r = r || g.getRequestType(e.url), !this.inited) throw new Error("请先调用cloud.init()");return r !== d.GATEWAY ? [3, 2] : [4, this.sendGatewayRequest(e)];case 1:
    ...
    return undefined === n && (n = "main"), p(this, undefined, undefined, function () {
      return k(this, function (t) {
        switch (t.label) {case 0:
    ...
    return p(this, undefined, undefined, function () {
      var e, r, n, o, i, a, s, c, u, l, p, d, h, f, v, y, m, w, g, b, _, x, A, q, R;return k(this, function (t) {
        switch (t.label) {case 0:
            e = S.filePath, r = S.fileType, n = undefined === r ? H : r, o = S.fileName, i = undefined === o ? "miniappfile" : o, a = S.seller, s = undefined !== a && a, c = S.dirId, t.label = 1;case 1:
            return t.trys.push([1, 3,, 4]), l = s ? E : M, [4, this.storageRequest(l, { newContainer: true, cloudPath: i, fileType: n, sellerSpace: s, dirId: c })];case 2:
            return u = t.sent(), [3, 4];case 3:
            throw p = t.sent(), new Error("获取配置错误" + (p.message || p.toString()));case 4:
            return d = T(u, ["data", "model", n], {}), h = d.url, f = undefined === h ? "" : h, v = d.formData, y = undefined === v ? null : v, m = d.headers, (w = { url: f, fileType: n, header: undefined === m ? null : m, formData: y, filePath: e, fileName: "file" }).header && w.header.Authorization && (w.formData.Authorization = w.header.Authorization), i && (w.formData.localFileName = Date.now() + "-" + function (t) {
              if (!t) return "file";var e = t.lastIndexOf("/");return 0 <= e ? t.substr(e + 1) : t;
            }(i)), w.header ? "image" !== n && (w.header.origin = w.header.origin || "https://miniapp-cloud.taobao.com", w.header.referer = w.header.referer || "https://miniapp-cloud.taobao.com") : delete w.header, w.formData || delete w.formData, [4, this.storageRequest("my.uploadFile", w)];case 5:
            if (g = t.sent(), b = this.parseUploadResult(n, g), _ = b.imageUrl, x = b.specialId, A = b.message, !x) throw new Error(A || "upload exception:unknown error");return q = { fileType: n, specialId: x, url: _, cloudPath: i, sellerSpace: s }, [4, this.storageRequest(s ? P : O, q)];case 6:
            if (!T(R = t.sent(), "data.model.url")) throw new Error(T(R, ["result", "msgInfo"], "上传失败"));return [2, T(R, "data.model")];}
      });
    });
  }, D.prototype.deleteFile = function (c) {
    return p(this, undefined, undefined, function () {
      var e, r, n, o, i, a, s;return k(this, function (t) {
        switch (t.label) {case 0:
            return e = c.fileId, r = c.fileType, n = undefined === r ? H : r, o = c.seller, i = undefined !== o && o, a = Array.isArray(e) ? e : [e], a = JSON.stringify(a), [4, this.storageRequest(i ? S : R, { fileType: n, fileIds: a, sellerSpace: i })];case 1:
            if (T(s = t.sent(), ["data", "model"])) return [2, true];throw new Error(T(s, ["data", "msgInfo"]));}
      });
    });
  }, D.prototype.getTempFileURL = function (s) {
    return p(this, undefined, undefined, function () {
      var e, r, n, o, i, a;return k(this, function (t) {
        switch (t.label) {case 0:
            if (e = s.fileId, r = s.seller, n = undefined !== r && r, !e) throw new Error("缺少fileId,请检查参数");return o = Array.isArray(e) ? e : [e], o = JSON.stringify(o), [4, this.storageRequest(n ? B : I, { fileIds: o, sellerSpace: n })];case 1:
            if (i = t.sent(), a = T(i, ["data", "model"])) return [2, a];throw new Error(T(i, ["data", "msgInfo"]));}
      });
    });
  }, D.prototype.downloadByFileId = function (l) {
    return p(this, undefined, undefined, function () {
      var e, r, n, o, i, a, s, c, u;return k(this, function (t) {
        switch (t.label) {case 0:
            if (e = l.fileId, r = l.cache, !e) throw new Error("缺少fileId,请检查参数");return n = Array.isArray(e) ? e : [e], [4, this.storageRequest(I, { fileIds: JSON.stringify(n) })];case 1:
    ...
    return p(this, undefined, undefined, function () {
      var e, r;return k(this, function (t) {
        switch (t.label) {case 0:
    ...
    return undefined === n && (n = {}), p(this, undefined, undefined, function () {
      var e;return k(this, function (t) {
        switch (t.label) {case 0:
    ...
    return p(this, undefined, undefined, function () {
      var e;return k(this, function (t) {
        switch (t.label) {case 0:
            return "test" !== (e = this.options.env) && (e = "online"), n = h(h({}, n), { env: e }), [4, this.request.exec({ env: e, url: "db/" + r, data: n }, d.GATEWAY)];case 1:
            return [2, t.sent()];}
      });
    });
    ...
    return p(this, undefined, undefined, function () {
      var e, i, a, s, c, u, l, p;return k(this, function (t) {
        switch (t.label) {case 0:
            ...
            return [4, (r = my.authorize, n = { scopes: a }, r ? (n = n || {}, new Promise(function (t, e) {
              r.call(o || my, h(h({}, n), { success: t, fail: e }));
            ...
            throw new Error("" + JSON.stringify(T(u, "error_response")));}var r, n, o;
      });
    });
    ...
    return p(this, undefined, undefined, function () {
      var e, r, n;return k(this, function (t) {
        switch (t.label) {case 0:
    ...
    return p(this, undefined, undefined, function () {
      var e, r, n, o;return k(this, function (t) {
        switch (t.label) {case 0:
    ...
    var t = null !== ot && ot.apply(this, arguments) || this;return t.sendMtop = function (i, a, s) {
      return p(t, undefined, undefined, function () {
        return k(this, function (t) {
          return console.log("sendMtop", a), [2, new Promise(function (r, n) {
            var e = 1,
                o = function () {
              my.sendMtop(h(h({ api: i, v: "1.0", data: a, method: "POST" }, s), { success: function (t) {
                  var e = at.getMtopErrorMsg(t);e ? n(e) : r(t);
                }, fail: function (t) {
                  if (1 === t.error_type && 0 < e) return --e, o();n(at.getMtopErrorMsg(t));
                } }));
            };o();
          })];
        });
      ...
      return p(t, undefined, undefined, function () {
        return k(this, function (t) {
          return [2, new Promise(function (t, e) {
            return r = r.replace(/^my\./, ""), my[r](h(h({}, n), { success: t, fail: e }));
          })];
        });
      });
        ...
        var e = this;return k(this, function (t) {
          return [2, new Promise(function (r, t) {
            my.httpRequest({ url: e.options.gatewayUrl + "/" + n, data: o, dataType: "text", method: a, headers: i, success: function (e) {
                try {
                  r(h(h({}, e), { data: JSON.parse(e.data) }));
                } catch (t) {
                  r(h(h({}, e), { data: e.data }));
                }
              }, fail: t });
      ...
      return p(t, undefined, undefined, function () {
        var e, r, n, o, i, a, s, c;return k(this, function (t) {
          switch (t.label) {case 0:
              return e = u.url, r = u.data, n = u.headers, o = u.mtopOptions, i = u.method, l !== d.MTOP ? [3, 2] : [4, this.sendMtop(e, r, o)];case 1:
              return [2, t.sent()];case 2:
              return l !== d.GATEWAY ? [3, 8] : this.options.gatewayUrl ? [4, this.sendHttpRequest(e, r, n, i)] : [3, 4];case 3:
              ...
              }), [4, this.sendMtop(at.GATEWAY_APIS[e], h(h({}, u.rawData), { protocols: JSON.stringify(n) }), o)];case 5:
    ...
    return p(this, undefined, undefined, function () {
      var r, n, o;return k(this, function (t) {
        switch (t.label) {case 0:
            return t.trys.push([0, 2,, 3]), e = i.env, r = "string" == typeof (e = e || "online") ? { database: e, file: e, function: e, message: e } : (e.database = e.database || "online", e.file = e.file || "online", e.function = e.function || "online", e.message = e.message || "online", e), n = new w(), this.db = new N({ env: r.database }, n), this.function = new x({ env: r.function }, n), this.file = new C({ env: r.file }, n), this.qimenApi = new X({ env: r.database }, n), this.topApi = new Y({ env: r.database }, n), this.processApi = new K({ env: r.database }, n), this.application = new Z({ env: r.database }, n), [4, n.init(h({}, i), a || new it({ gatewayUrl: i.__gatewayUrl }))];case 1:
